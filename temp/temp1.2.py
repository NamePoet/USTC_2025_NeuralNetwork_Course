    ...
    def fit_model(self, train_data, num_epochs, batch_size):
        ...
        for epoch in range(num_epochs):
            ...
            for mini_batch in mini_batches:
                ...
                loss = criterion(outputs, y)    # 使用均方误差（MSELoss）计算回归任务的损失函数
                optimizer.zero_grad()           # 清空上一次的梯度（由于PyTorch 默认梯度是累积的，所以每次迭代前都需要清除梯度）
...
model.fit_model(train_data, num_epochs=200, batch_size=16)     # num_epochs可取20
