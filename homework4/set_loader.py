...
pairs_path = "facenet/datasets/lfw/pairs.txt"
testset_path = "facenet/datasets/lfw/lfw_mtcnnpy_160"
image_size = 160
...
def load_testset(size):
    ...
    # Load images
    faces1 = facenet_fn.load_data(paths_batch_1, False, False, image_size)
    faces2 = facenet_fn.load_data(paths_batch_2, False, False, image_size)
